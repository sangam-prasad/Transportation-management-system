    ...
    while(1)
        {
                ...
                printf("\t\t                    PASSWORD PROTECTED RECORD DIARY                      \n");
...

{
        ...
        char vehicle[6],choice,filename[14];
        ...
        do

            {
                ...
                printf("\n\t2->RECORD OF FIX VEHICLE NUMBER.");
...

                {
                    ...
                    case 1:
...

                         {
                            ...
                            printf("\nVEHICLE NUMBER: %s",customer.vehicle);
                    ...
                    case 2:
...

                            {
                                ...
                                if(strcmp(customer.vehicle,vehicle)==0)
...

{
                ...
                char filename[15],another = 'Y' ,vehicle[10];
                ...
                printf("\n\t2->DELETE A PARTICULAR RECORD BY VEHICLE NUMBER");
...

                {
                    ...
                    switch(choice)

                        {
                            ...
                            printf("\n\tENTER THE VEHICLE NUMBER WHOSE RECORD TO BE DELETED");
...

                            {
                                ...
                                if(strcmp(file.vehicle,vehicle)!=0)
